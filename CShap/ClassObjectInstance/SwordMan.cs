...
namespace ClassObjectInstance
{
    ...
    internal class SwordMan
    {
        ...
        //snake_case
        //UPPER_SNAKE_CASE
        // m_hungarian , FValue ( 일반적으로사용X )

        //접근제한자
        // public : 접근 제한 없음
        // protected : 자식(상속 타입)이 부모(기반 타입) 에 접근할 수 있음
        // internal : 동일 어셈블리(프로젝트)에서 제한없이 접근 가능
        // private : 타 클래스 접근 불가능
        // 클래스는 기본적으로 캡슐화를 위한 타입이기 때문에
        // 접근제한자가 명시되지 않을 경우에 default 접근제한자는 private임.
        ...
        // 해당객체가 더이상 참조되지 않을때 .Net 의 CLR의 Garbagecollector 가
